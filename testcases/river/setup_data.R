...
temp.w.1 = read.delim("FGG_Elbe_012!Wassertemperatur.txt", header=FALSE, comment.char="#")
temp.w.2 = read.delim("FGG_Elbe_013!Wassertemperatur.txt", header=FALSE, comment.char="#")
...
oxy.w.1 = read.delim("FGG_Elbe_012!Sauerstoffgehalt_(Einzelmessung).txt", header=FALSE, comment.char="#")
oxy.w.2 = read.delim("FGG_Elbe_013!Sauerstoffgehalt_(Einzelmessung).txt", header=FALSE, comment.char="#")
